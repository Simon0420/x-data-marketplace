        ...
        return (
            ...
            <div id="outer-container">
                <Menu styles={ styles } noOverlay className="menucontent" pageWrapId="page-wrap" >
                    ...
                    <a id="market" className="menu-item" href="/about"><i class="ion-bag" aria-hidden="true"></i> Market</a>
                    <a id="data" className="menu-item" href="/data"><i class="ion-stats-bars" aria-hidden="true"></i> My Data</a>
                    <a id="integration" className="menu-item" href="/contact"><i class="ion-shuffle" aria-hidden="true"></i> Integration</a>
                    <a id="upload" className="menu-item" href="/contact"><i class="ion-upload" aria-hidden="true"></i> Upload</a>
                    <a onClick={ this.showSettings } className="menu-item--small" href=""><i class="ion-star" aria-hidden="true"></i> Services</a>
                </Menu>
                <main id="page-wrap">
